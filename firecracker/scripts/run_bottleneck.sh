...
#   ~/results/<task>/firecracker/<label>/<timestamp>/results.json
#   ~/results/<task>/firecracker/<label>/<timestamp>/bottleneck_logs/
#
# Examples:
#   sudo ./run_bottleneck.sh /opt/firecracker/rootfs-task.ext4 --label 16c
#   sudo ./run_bottleneck.sh /opt/firecracker/rootfs-task.ext4 --label 16c --repeats 3
# =============================================================================
