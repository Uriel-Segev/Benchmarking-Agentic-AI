...
#
# Examples:
#   sudo ./run_scaling.sh /opt/firecracker/rootfs-task.ext4 64 --label 16c --repeats 5
#   sudo ./run_scaling.sh /opt/firecracker/rootfs-task.ext4 64 --label 16c --resume --output /path/to/old.json
# =============================================================================
