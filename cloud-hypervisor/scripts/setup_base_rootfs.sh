#!/usr/bin/env bash
# =============================================================================
# Setup base Ubuntu rootfs for Cloud Hypervisor
#
# This script:
#   1. Creates an ext4 image using debootstrap
#   2. Configures systemd, serial console, and root login
#   3. Produces a bootable base rootfs for Cloud Hypervisor
#
# Run AFTER install_cloud_hypervisor.sh, BEFORE prepare_task_rootfs.sh
#
# Usage:
...
log "Configuring rootfs for Cloud Hypervisor boot"

# Set hostname
echo "cloud-hypervisor-vm" > "${MOUNT_POINT}/etc/hostname"
...
# Enable serial console for ttyS0 (Cloud Hypervisor with --serial tty)
